...
Step 1:Reason step-by-step about the relationship of the history operation sequence and UI task.
Step 2:Reason step-by-step about whether the newest action and the newest UI screen are relevant to the UI task. Is there any element on the screen is related with the task and you think that it should be operated next?
