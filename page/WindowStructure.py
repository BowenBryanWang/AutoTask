...
class UINode:
    ...
    def is_selected(self):
        prob = 1
        if self.resource_id == "com.android.settings:id/search_action_bar" or self.text == "Search settings" or self.content_desc == "Search settings" or self.resource_id == "com.google.android.gm:id/open_search":
            # disable search
            return 0
